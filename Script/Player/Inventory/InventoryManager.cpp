...
InventoryManager::InventoryManager() {
    ...
    addItem( (int)ItemID::Iron_Pickage, 1);
    addItem( (int)BLOCKID::Wood, 64);
    addItem( (int)BLOCKID::CraftingTable, 1);
    addItem((int)ItemID::Laser , 64);
    addItem((int)ItemID::Iron, 64);

    addItem((int)ItemID::Copper, 64);
    addItem((int)ItemID::Blue, 64);

    addItem((int)ItemID::Coal, 64);
    addItem((int)BLOCKID::SpecialWood, 64);
